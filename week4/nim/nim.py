...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        # Return the Q-value if it exists, otherwise return 0
    ...
    def best_future_reward(self, state):
        ...
        `state`, return 0.
        """
        # Get all available actions for the state
    ...
    def choose_action(self, state, epsilon=True):
        ...
        if epsilon and random.random() < self.epsilon:
            ...
            # Otherwise, choose the best action (highest Q-value)
            best_q = float('-inf')
            best_actions = []
            
            # Find all actions with the highest Q-value
            ...
            # Return a random action among those with the highest Q-value
